        ...
        private static JToken CreateProjectParameter(Document doc, JObject parameters)
        {
            ...
            try
            {
                ...
                var defFile = System.IO.Path.Combine(
                    System.IO.Path.GetTempPath(), "BIMBot_SharedParams.txt");
                ...
                var groupDef = defFileObj.Groups.get_Item("BIMBot")
                    ?? defFileObj.Groups.Create("BIMBot");
            ...
            using (var tx = new Transaction(doc, "Add Shared Parameter"))
            {
                ...
                try
                {
                    ...
                    if (defFile == null)
                    {
                        ...
                        var tempPath = System.IO.Path.Combine(System.IO.Path.GetTempPath(), "BIMBot_SharedParams.txt");
