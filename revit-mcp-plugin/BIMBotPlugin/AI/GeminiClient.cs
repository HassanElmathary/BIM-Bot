...
namespace BIMBotPlugin.AI
{
    ...
    public class GeminiSettings
    {
        ...
        private static string SettingsPath => Path.Combine(
            ...
            "Autodesk", "Revit", "Addins", "BIMBot", "gemini-settings.json");
    ...
    public class GeminiClient
    {
        ...
        private async Task<GeminiResponse> CallOpenAICompatibleAsync()
        {
            ...
            if (_settings.IsOpenRouter)
            {
                ...
                request.Headers.Add("X-Title", "BIM-Bot");
            }
        ...
        /// <summary>Saves debug info to %APPDATA%/BIMBot/ for API diagnostics.</summary>
