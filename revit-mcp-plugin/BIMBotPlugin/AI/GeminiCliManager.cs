...
namespace BIMBotPlugin.AI
{
    ...
    public class GeminiCliManager
    {
        ...
        /// <summary>
        /// Generates the ~/.gemini/settings.json config file pointing to the BIM-Bot MCP server.
        /// </summary>
            ...
            try
            {
                ...
                if (File.Exists(configPath))
                {
                    try
                    {
                        ...
                        servers["bim-bot"] = config["mcpServers"]!["bim-bot"];
        ...
        private string ResolveServerPath(string customPath)
        {
            ...
            var installedPath = Path.Combine(appData, "BIMBot", "server", "build", "index.js");
