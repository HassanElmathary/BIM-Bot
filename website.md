...
Large CTA button:
> **Download BIM-Bot v2.3.1** — `BIMBot-Setup-2.3.1.exe` (Windows)
...
**One-Line Uninstall:**
```powershell
irm https://raw.githubusercontent.com/HassanElmathary/BIM-Bot/main/install.ps1 | iex; Install-BIMBot -Uninstall
```
...
- [x] What's the installer filename for download? *(BIMBot-Setup-2.3.1.exe)*
