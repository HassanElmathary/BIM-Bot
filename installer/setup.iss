...
;  AI-Powered BIM Automation • 183 MCP Tools • Revit 2020–2027
...
WelcomeLabel2=This will install {#MyAppName} v{#MyAppVersion} on your computer.%n%n{#MyAppName} provides 183 AI-powered MCP tools for Autodesk Revit, enabling intelligent BIM automation through Claude Desktop, Cursor, Windsurf, and any MCP client.%n%nSupports Revit 2020–2027.
...
[Components]
Name: "server"; Description: "MCP Server (Node.js) — 183 AI tools for BIM automation"; Types: full server custom; Flags: fixed
